...
// Zajištění registrace parserů
import "../../Functions/parsers/index.js";
...
function FileProcessor() {
    ...
    const handleSendToServer = async (uuid) => {
        ...
        // console.log("Objekt, který mapuješ a posíláš na server : data");
        // console.log(data);
        ...
        // console.log("Finální objekt k odeslání na server : sendValues");
