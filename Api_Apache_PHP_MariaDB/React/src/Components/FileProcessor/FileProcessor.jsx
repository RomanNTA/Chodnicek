...
import {
    ...
    GetNET_JSON,
    GetDataFromServer,
} from "../../Functions/GetDataFromServer.js";
...
function FileProcessor() {
    ...
    /**
     *  Vymazání lokální databáze ... v aplikaci nepoužité ... jen pro DEBUG !!!
     */
    ...
    const handleDeleteFileFromList = async (uuid, src) => {
        ...
        try {
            ...
            switch (src) {
                ...
                //
                case "NETSRC-DB": {
                    let result = await DeleteItemsOnServer({ uuid: uuid });
                    break;
                }
                default:
                    console.log(
    ...
    const handleSendToServer = async (uuid) => {
        ...
        let result = await SendDataToServer(JSON.stringify(sendValues));
        if (result) {
