...
import { MapContext, DataContext, RouteContext } from "../../GlobalContext";
...
function MapComponent() {
     ...
     * ------------------------------------------------------------------------------------------------------------------- */
    useEffect(() => {
        //console.log(`Nastavuji novou pozici. ${M.position}, ${M.zoom}`);
        if (M.mapa != null) {
            M.mapa.flyTo(M.position, M.zoom);
        } else {
            console.log(`Nenastaveno ... mapa není k dispozici.`);
        }
    }, [M.position]); // ,
